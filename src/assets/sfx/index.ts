import { default as Cheer } from './cheer.mp3';
import { default as Collide } from './collide.mp3';
import { default as DiceRoll } from './dice_roll.mp3';
import { default as GameStart } from './game_start.mp3';
